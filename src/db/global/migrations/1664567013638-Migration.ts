...
export class Migration1664567013638 implements MigrationInterface {
    name = 'Migration1664567013638'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "permissions" ("id" int NOT NULL IDENTITY(1,1), "id_department" int NOT NULL, "active" int NOT NULL CONSTRAINT "DF_6c05a77b08a9c4631ec33871490" DEFAULT 1, "createdAt" datetime2 NOT NULL CONSTRAINT "DF_da04f89054f39981438894dfe30" DEFAULT getdate(), "updatedAt" datetime2 NOT NULL CONSTRAINT "DF_14936cb23d7de4c7b31b5cef053" DEFAULT getdate(), "id_rol" int, "id_action" int, CONSTRAINT "PK_920331560282b8bd21bb02290df" PRIMARY KEY ("id"))`);
