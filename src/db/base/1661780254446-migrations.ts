...
export class migrations1661780254446 implements MigrationInterface {
    name = 'migrations1661780254446'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "milpagos".."ejecutado_contracargo" ADD CONSTRAINT "FK_803f0d64b1606c50350471d944c" FOREIGN KEY ("id_usuario") REFERENCES "milpagos".."usuarios"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "milpagos".."ejecutado_contracargo" DROP CONSTRAINT "FK_803f0d64b1606c50350471d944c"`);
        ...
        await queryRunner.query(`DROP TABLE "milpagos".."ejecutado_contracargo"`);
